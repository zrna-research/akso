...
#define HOST_POWERSW_CLK_ENABLE()          __GPIOH_CLK_ENABLE()
...
static char mem[256] __attribute__ ((section (".ram3"))) __attribute__ ((aligned (32)));
bool memused __attribute__ ((section (".ram3"))) __attribute__ ((aligned (32))) = 0;
...
__INLINE USBH_URBStateTypeDef USBH_LL_GetURBState(USBH_HandleTypeDef *phost,
                                        uint8_t pipe) {
...
__INLINE USBH_StatusTypeDef USBH_LL_SubmitURB(USBH_HandleTypeDef *phost, uint8_t pipe,
