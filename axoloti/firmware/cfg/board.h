 ...
 * PA15 - PIN15                     SPI3 NSS
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_BUTTON) |         \
                                     PIN_MODE_ANALOG(GPIOA_PIN1) |           \
                                     PIN_MODE_ANALOG(GPIOA_PIN2) |           \
                                     PIN_MODE_ANALOG(GPIOA_PIN3) |           \
                                     PIN_MODE_ANALOG(GPIOA_LRCK) |       \
                                     PIN_MODE_ANALOG(GPIOA_SPC) |        \
                                     PIN_MODE_ANALOG(GPIOA_SDO) |        \
                                     PIN_MODE_ANALOG(GPIOA_SDI) |        \
                                     PIN_MODE_INPUT(GPIOA_PIN8) |           \
                                     PIN_MODE_ANALOG(GPIOA_VBUS_FS) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_BUTTON) |     \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_OTG_FS_ID) |  \
...
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_PIN0) |       \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOD_OVER_CURRENT) |   \
...
#define VAL_GPIOH_MODER             (PIN_MODE_INPUT(GPIOH_OSC_IN) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOH_PIN9) |           \
                                     PIN_MODE_OUTPUT(GPIOH_PIN10) |          \
                                     PIN_MODE_INPUT(GPIOH_PIN11) |          \
                                     PIN_MODE_INPUT(GPIOH_PIN12) |          \
                                     PIN_MODE_OUTPUT(GPIOH_PIN13) |          \
                                     PIN_MODE_OUTPUT(GPIOH_PIN14) |          \
...
#define VAL_GPIOI_MODER             (PIN_MODE_INPUT(GPIOI_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOI_PIN7) |           \
                                     PIN_MODE_OUTPUT(GPIOI_PIN8) |           \
                                     PIN_MODE_INPUT(GPIOI_PIN9) |           \
                                     PIN_MODE_OUTPUT(GPIOI_PIN10) |          \
