    ...
    public final void resetLibraries(boolean delete) {
        ...
        try {
            AxoGitLibrary factory = new AxoGitLibrary(
                    ...
                    "git",
                    new File(Axoloti.defaultObjectLibraryDirectory() + File.separator + "akso-factory").getCanonicalPath() + File.separator,
                    true,
                    "https://github.com/zrna-research/akso-factory.git",
                    false
            );
            ...
            libraries.add(new AxoFileLibrary(
                    "home",
                    "local",
                    new File(Axoloti.defaultObjectLibraryDirectory()).getCanonicalPath() + File.separator,
                    true
            ));
            ...
            libraries.add(new AxoGitLibrary(
                    ...
                    "git",
                    new File(Axoloti.defaultObjectLibraryDirectory() + File.separator + "akso-community").getCanonicalPath() + File.separator,
                    true,
                    "https://github.com/zrna-research/akso-community.git",
                    false
            ));
