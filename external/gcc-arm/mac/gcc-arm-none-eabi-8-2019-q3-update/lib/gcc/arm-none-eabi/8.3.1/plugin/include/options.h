...
enum opt_code
{
  ...
  OPT_mabi_ = 1192,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1193,             /* -mabort-on-noreturn */
  OPT_mapcs = 1194,                          /* -mapcs */
  OPT_mapcs_frame = 1195,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1196,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1197,              /* -mapcs-stack-check */
  OPT_march_ = 1198,                         /* -march= */
  OPT_marm = 1199,                           /* -marm */
  OPT_masm_syntax_unified = 1200,            /* -masm-syntax-unified */
  OPT_mbe32 = 1201,                          /* -mbe32 */
  OPT_mbe8 = 1202,                           /* -mbe8 */
  OPT_mbig_endian = 1203,                    /* -mbig-endian */
  ...
  OPT_mfpu_ = 1213,                          /* -mfpu= */
  /* OPT_mhard_float = 1214, */              /* -mhard-float */
  OPT_mlittle_endian = 1215,                 /* -mlittle-endian */
  OPT_mlong_calls = 1216,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1217,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1218,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1219,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1220,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1221,               /* -mprint-tune-info */
  OPT_mpure_code = 1222,                     /* -mpure-code */
  OPT_mrestrict_it = 1223,                   /* -mrestrict-it */
  OPT_msched_prolog = 1224,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1225,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1226,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1227, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1228,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1229,                         /* -mthumb */
  OPT_mthumb_interwork = 1230,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1231,                  /* -mtls-dialect= */
  OPT_mtp_ = 1232,                           /* -mtp= */
  OPT_mtpcs_frame = 1233,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1234,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1235,                         /* -mtune= */
  OPT_munaligned_access = 1236,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1237,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1238,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1239,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1240,              /* -mword-relocations */
  OPT_n = 1241,                              /* -n */
  OPT_no_canonical_prefixes = 1242,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1243,              /* -no-integrated-cpp */
  OPT_no_pie = 1244,                         /* -no-pie */
  OPT_nocpp = 1245,                          /* -nocpp */
  OPT_nodefaultlibs = 1246,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1247,                   /* -nostartfiles */
  OPT_nostdinc = 1248,                       /* -nostdinc */
  OPT_nostdinc__ = 1249,                     /* -nostdinc++ */
  OPT_nostdlib = 1250,                       /* -nostdlib */
  OPT_o = 1251,                              /* -o */
  OPT_p = 1252,                              /* -p */
  OPT_pass_exit_codes = 1253,                /* -pass-exit-codes */
  /* OPT_pedantic = 1254, */                 /* -pedantic */
  OPT_pedantic_errors = 1255,                /* -pedantic-errors */
  OPT_pg = 1256,                             /* -pg */
  OPT_pie = 1257,                            /* -pie */
  OPT_pipe = 1258,                           /* -pipe */
  ...
  OPT_quiet = 1270,                          /* -quiet */
  OPT_r = 1271,                              /* -r */
  OPT_remap = 1272,                          /* -remap */
  OPT_s = 1273,                              /* -s */
  OPT_save_temps = 1274,                     /* -save-temps */
  OPT_save_temps_ = 1275,                    /* -save-temps= */
  OPT_shared = 1276,                         /* -shared */
  OPT_shared_libgcc = 1277,                  /* -shared-libgcc */
  /* OPT_specs = 1278, */                    /* -specs */
  OPT_specs_ = 1279,                         /* -specs= */
  OPT_static = 1280,                         /* -static */
  OPT_static_libasan = 1281,                 /* -static-libasan */
  OPT_static_libgcc = 1282,                  /* -static-libgcc */
  OPT_static_libgfortran = 1283,             /* -static-libgfortran */
  OPT_static_libgo = 1284,                   /* -static-libgo */
  OPT_static_liblsan = 1285,                 /* -static-liblsan */
  OPT_static_libmpx = 1286,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1287,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1288,               /* -static-libstdc++ */
  OPT_static_libtsan = 1289,                 /* -static-libtsan */
  OPT_static_libubsan = 1290,                /* -static-libubsan */
  OPT_static_pie = 1291,                     /* -static-pie */
  /* OPT_std_c__03 = 1292, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1293, */                /* -std=c++0x */
  OPT_std_c__11 = 1294,                      /* -std=c++11 */
  OPT_std_c__14 = 1295,                      /* -std=c++14 */
  OPT_std_c__17 = 1296,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1297, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1298, */                /* -std=c++1z */
  OPT_std_c__2a = 1299,                      /* -std=c++2a */
  OPT_std_c__98 = 1300,                      /* -std=c++98 */
  OPT_std_c11 = 1301,                        /* -std=c11 */
  OPT_std_c17 = 1302,                        /* -std=c17 */
  /* OPT_std_c18 = 1303, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1322,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1323,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1324,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1325,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1326, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1327, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1328, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1329,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1330,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1331, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1332, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1333,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1334, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1335, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1336, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1337, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1338, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1339,                     /* -std=legacy */
  OPT_symbolic = 1340,                       /* -symbolic */
  OPT_t = 1341,                              /* -t */
  OPT_time = 1342,                           /* -time */
  OPT_time_ = 1343,                          /* -time= */
  OPT_traditional = 1344,                    /* -traditional */
  OPT_traditional_cpp = 1345,                /* -traditional-cpp */
  OPT_trigraphs = 1346,                      /* -trigraphs */
  OPT_u = 1347,                              /* -u */
  OPT_undef = 1348,                          /* -undef */
  OPT_v = 1349,                              /* -v */
  OPT_version = 1350,                        /* -version */
  OPT_w = 1351,                              /* -w */
  OPT_wrapper = 1352,                        /* -wrapper */
  OPT_x = 1353,                              /* -x */
  OPT_z = 1354,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
